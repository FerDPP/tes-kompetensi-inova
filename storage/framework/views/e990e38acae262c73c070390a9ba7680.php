...
<h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">
            <?php echo e(__('Kasir Register')); ?>

    </h2>
    <form method="POST" action="<?php echo e(route('kasir.register')); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\LENOVO\OneDrive\Dokumen\Belajar\multiuser_laravel\multiuser_laravsebelas\laravel-11-multi-auth\resources\views/kasir/auth/register.blade.php ENDPATH**/ ?>